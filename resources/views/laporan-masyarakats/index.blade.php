<x-layout title="Laporan Masyarakat">
    <x-page-header 
        title="Laporan & Aduan Masyarakat"
        subtitle="Daftar aduan, aspirasi, dan laporan warga terkait pelayanan Posyandu"
        icon="mdi-message-alert"
        :breadcrumbs="[
            'Interaksi' => null,
            'Laporan Masyarakat' => null
        ]"
    >
        ...
        <a href="{{ route('laporan-masyarakats.create') }}" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-xs transition flex items-center gap-2 shadow-xs">
            <i class="mdi mdi-plus text-sm"></i> <span>Buat Laporan</span>
        </a>
    </x-page-header>
