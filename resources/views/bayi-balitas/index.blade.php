...
<x-layout title="Data Bayi">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Data Bayi</h2>
        <div class="flex space-x-2">
            <a id="export-excel" href="{{ route('bayi-balitas.export') }}" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition flex items-center gap-2">
                <i class="mdi mdi-file-excel"></i> <span>Export Excel</span>
            </a>
            <a href="{{ route('bayi-balitas.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition flex items-center gap-2">
