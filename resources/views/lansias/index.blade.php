...
<x-layout title="Data Lansia">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Data Lansia</h2>
            <p class="text-sm text-gray-500">Daftar penduduk dengan usia minimal {{ $minAge }} tahun.</p>
        </div>
        <div class="flex space-x-2">
            <a id="export-excel" href="{{ route('lansias.export') }}" class="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition flex items-center gap-2 shadow-sm">
