...
<x-layout title="Tambah Berita">
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Berita</h2>
            <p class="text-gray-500 mt-1">Lengkapi informasi berita di bawah ini dengan benar.</p>
        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" value="{{ old('slug') }}" placeholder="slug-berita-otomatis" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
