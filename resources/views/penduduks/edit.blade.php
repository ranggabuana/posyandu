                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="nama" value="{{ old('nama', $penduduk->nama) }}" placeholder="Masukkan nama lengkap" 
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" value="{{ old('nik', $penduduk->nik) }}" placeholder="Masukkan NIK" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <select name="kelamin" 
                                ...
                                <option value="laki-laki" {{ old('kelamin', $penduduk->kelamin) == 'laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="perempuan" {{ old('kelamin', $penduduk->kelamin) == 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="tempatlahir" value="{{ old('tempatlahir', $penduduk->tempatlahir) }}" placeholder="Masukkan tempat lahir" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggallahir" value="{{ old('tanggallahir', $penduduk->tanggallahir) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="agama" value="{{ old('agama', $penduduk->agama) }}" placeholder="Masukkan agama" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="pendidikan" value="{{ old('pendidikan', $penduduk->pendidikan) }}" placeholder="Masukkan pendidikan" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="pekerjaan" value="{{ old('pekerjaan', $penduduk->pekerjaan) }}" placeholder="Masukkan pekerjaan" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="no_kk" value="{{ old('no_kk', $penduduk->no_kk) }}" placeholder="Masukkan No KK" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_kk" value="{{ old('nama_kk', $penduduk->nama_kk) }}" placeholder="Masukkan nama KK" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="hubungan_keluarga" value="{{ old('hubungan_keluarga', $penduduk->hubungan_keluarga) }}" placeholder="Contoh: Kepala Keluarga, Istri, Anak" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_ayah" value="{{ old('nama_ayah', $penduduk->nama_ayah) }}" placeholder="Masukkan nama ayah" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_ibu" value="{{ old('nama_ibu', $penduduk->nama_ibu) }}" placeholder="Masukkan nama ibu" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
                        <div class="md:col-span-3">
                            ...
                            <textarea name="alamat" rows="3" placeholder="Masukkan alamat lengkap..." 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">{{ old('alamat', $penduduk->alamat) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="dusun" value="{{ old('dusun', $penduduk->dusun) }}" placeholder="Masukkan dusun" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="rt" value="{{ old('rt', $penduduk->rt) }}" placeholder="RT" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="rw" value="{{ old('rw', $penduduk->rw) }}" placeholder="RW" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="telepon" value="{{ old('telepon', $penduduk->telepon) }}" placeholder="Masukkan no telepon" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <select name="goldar" 
                                ...
                                @foreach(['A', 'B', 'AB', 'O', 'A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $gd)
                                    <option value="{{ $gd }}" {{ old('goldar', $penduduk->goldar) == $gd ? 'selected' : '' }}>{{ $gd }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="checkbox" name="bpjs" value="1" {{ old('bpjs', $penduduk->bpjs) ? 'checked' : '' }}
