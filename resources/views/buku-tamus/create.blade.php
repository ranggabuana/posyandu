...
<x-layout title="Tambah Buku Tamu">
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Buku Tamu</h2>
            <p class="text-gray-500 mt-1">Lengkapi informasi kunjungan di bawah ini dengan benar.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
            <div class="px-8 py-5 border-b border-gray-50 bg-gray-50/30">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-800">Formulir Buku Tamu</h3>
                </div>
            </div>
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="jabatan" value="{{ old('jabatan') }}" placeholder="Masukkan jabatan" required
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="keperluan" value="{{ old('keperluan') }}" placeholder="Masukkan tujuan kunjungan" required
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-700 font-semibold text-sm flex items-center gap-2">
                            <i class="mdi mdi-office-building text-blue-600 text-lg"></i>
                            {{ auth()->user()->posyandu->nama ?? 'Posyandu Saya' }}
                        </div>
                    </div>
                    @elseif(!empty($posyandus) && count($posyandus) > 0)
                    <div class="md:col-span-2">
