                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div>
                            ...
                            <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Masukkan nama tamu" 
                        ...
                        <div>
                            ...
                            <input type="text" name="instansi" value="{{ old('instansi') }}" placeholder="Masukkan instansi/lembaga" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="keperluan" value="{{ old('keperluan') }}" placeholder="Masukkan keperluan kunjungan" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_telepon" value="{{ old('no_telepon') }}" placeholder="Masukkan no telepon" 
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all duration-200">
