<x-layout title="Edit Posyandu">
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Edit Data Posyandu</h2>
            <p class="text-gray-500 mt-1">Perbarui informasi posyandu beserta detail akun login pengurus.</p>
        </div>
    ...
    <form action="{{ route('posyandus.update', $posyandu) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-8 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $posyandu->nama) }}" placeholder="Posyandu Melati..." required
                            ...
                            <div>
                                ...
                                <input type="text" name="ketua" value="{{ old('ketua', $posyandu->ketua) }}" placeholder="Nama Ketua"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" name="telepon" value="{{ old('telepon', $posyandu->telepon) }}" placeholder="No. Telepon"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                            ...
                            <div>
                                ...
                                <select name="dusun" id="select-dusun" required
                                    ...
                                    @foreach($dusuns as $dusun)
                                        <option value="{{ $dusun }}" {{ old('dusun', $posyandu->dusun) == $dusun ? 'selected' : '' }}>{{ $dusun }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            ...
                            <div id="rw-checkbox-container" class="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200 min-h-[60px] items-center">
                                @if(count($rws) > 0)
                                    @foreach($rws as $rw)
                                        @php
                                            $checked = in_array($rw, old('rw_diampu', $posyandu->rw_diampu ?? [])) ? 'checked' : '';
                                        @endphp
                                        <label class="flex items-center gap-2 p-2 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer select-none">
                                            <input type="checkbox" name="rw_diampu[]" value="{{ $rw }}" {{ $checked }} class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <textarea name="alamat" rows="3" placeholder="Alamat lengkap lokasi..."
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">{{ old('alamat', $posyandu->alamat) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="text" name="jadwal_rutin" value="{{ old('jadwal_rutin', $posyandu->jadwal_rutin) }}" placeholder="Contoh: Setiap Tanggal 15"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" name="lokasi_koordinat" value="{{ old('lokasi_koordinat', $posyandu->lokasi_koordinat) }}" placeholder="-7.432, 109.213"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                            ...
                            <div>
                                ...
                                <input type="number" name="jumlah_kader" value="{{ old('jumlah_kader', $posyandu->jumlah_kader) }}" min="0"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                        ...
                        <div>
                            ...
                            <input type="text" name="bangunan" value="{{ old('bangunan', $posyandu->bangunan) }}" placeholder="Contoh: Gedung Sendiri, Numpang Rumah Ketua, dll."
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">
                    ...
                    <div class="p-8 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-xl border border-gray-200 cursor-pointer select-none">
                                <input type="checkbox" name="punya_timbangan_dacin" value="1" {{ old('punya_timbangan_dacin', $posyandu->punya_timbangan_dacin) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <span class="text-sm font-semibold text-gray-700">Timbangan Dacin</span>
                            </label>

                            <label class="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-xl border border-gray-200 cursor-pointer select-none">
                                <input type="checkbox" name="punya_timbangan_digital" value="1" {{ old('punya_timbangan_digital', $posyandu->punya_timbangan_digital) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <span class="text-sm font-semibold text-gray-700">Timbangan Bayi Digital</span>
                            </label>

                            <label class="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-xl border border-gray-200 cursor-pointer select-none">
                                <input type="checkbox" name="punya_alat_ukur_tinggi" value="1" {{ old('punya_alat_ukur_tinggi', $posyandu->punya_alat_ukur_tinggi) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <span class="text-sm font-semibold text-gray-700">Alat Ukur Tinggi (Microtoise/Stadiometer)</span>
                            </label>

                            <label class="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-xl border border-gray-200 cursor-pointer select-none">
                                <input type="checkbox" name="punya_pita_liLa" value="1" {{ old('punya_pita_liLa', $posyandu->punya_pita_liLa) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <span class="text-sm font-semibold text-gray-700">Pita LiLa (Lingkar Lengan & Kepala)</span>
                            </label>

                            <label class="flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-xl border border-gray-200 cursor-pointer select-none">
                                <input type="checkbox" name="punya_buku_kia" value="1" {{ old('punya_buku_kia', $posyandu->punya_buku_kia) ? 'checked' : '' }} class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="pt-4">
                            ...
                            <textarea name="keterangan_lain" rows="3" placeholder="Informasi prasarana tambahan..."
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all">{{ old('keterangan_lain', $posyandu->keterangan_lain) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" name="username" value="{{ old('username', $user->username ?? '') }}" placeholder="Username pengurus" required
                        ...
                        <div class="p-3 bg-yellow-50 border border-yellow-150 rounded-xl">
                            <p class="text-[11px] text-yellow-800 font-semibold leading-relaxed flex items-start gap-1">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Initial load of RW checkboxes for edit
            const currentDusun = $('#select-dusun').val();
            const currentRws = @json(old('rw_diampu', $posyandu->rw_diampu ?? []));
            if (currentDusun) {
                loadRws(currentDusun, currentRws);
            }
        });
    </script>
</x-layout>
