<x-layout title="Tambah Data Balita">
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Tambah Data Balita</h2>
            <p class="text-gray-500 mt-1">Pilih data anak dari bayi untuk didaftarkan sebagai balita dan lengkapi informasinya.</p>
        </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <select name="bayi_balita_id" id="select2-bayi"
                                ...
                                @foreach($bayis as $bayi)
                                    <option value="{{ $bayi->id }}" {{ old('bayi_balita_id') == $bayi->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="status_akta" id="select-status-akta"
                                ...
                                <option value="punya" {{ old('status_akta', 'punya') == 'punya' ? 'selected' : '' }}>Punya</option>
                                <option value="tidak punya" {{ old('status_akta') == 'tidak punya' ? 'selected' : '' }}>Tidak Punya</option>
                            </select>
