...
class WusExport implements FromQuery, WithHeadings, WithEvents, WithCustomStartCell, ShouldAutoSize, WithMapping, WithColumnFormatting
{
    protected $filters;
    ...
    public function query()
    {
        ...
        $query = Penduduk::query()
            ->select('nama', 'nik', 'tanggallahir', 'dusun', 'rw', 'rt', 'telepon')
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'G' => NumberFormat::FORMAT_TEXT, // Telepon
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function(BeforeSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'LAPORAN DATA WUS (USIA ' . $minAge . ' - ' . $maxAge . ' TAHUN)');
