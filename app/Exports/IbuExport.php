...
class IbuExport implements FromQuery, WithHeadings, WithEvents, WithCustomStartCell, ShouldAutoSize, WithMapping, WithColumnFormatting
{
    protected $filters;
    ...
    public function map($penduduk): array
    {
        return [
            $penduduk->id,
            $penduduk->nama,
            $penduduk->no_kk . " ", // Add space to force string in some cases, but column formatting is primary
            $penduduk->nik . " ",
            $penduduk->nama_kk,
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function(BeforeSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'LAPORAN DATA IBU');
            ...
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle($headerRange)->applyFromArray([
                    ...
                    'fill' => [
                        ...
                        'startColor' => ['rgb' => '0F9A7B'], // Teal color from landing page
                    ],
                    'alignment' => [
